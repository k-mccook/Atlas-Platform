...
-- SELECT-only verification; safe before/after the indicated phase.
...
SELECT json_build_object(
 'expected_status', 'staged_provenance_review',
 'source_count', (SELECT count(*) FROM public.knowledge_sources WHERE id IN ('d8d4135c-ebb0-a85a-e945-57fecad637fb', 'c9342f90-4955-0f31-d4e8-7e6e9c19d03e', '54dcb2e9-4d49-cef1-60b6-cbb53a8e3fea', 'a0179c21-e82d-f250-698b-df393135b4e8', '7129b5e0-7066-50fa-1b60-10d84ac0cfc1', 'd52fbd0f-5332-bd27-d80f-273617ef1ff5', '4bc5728a-21ce-fad4-c0d2-615a9c00c43b', 'f4c72547-0ece-83da-63b3-828558cfe068', '4b3a8e18-9f2f-cd7e-bce1-309338405146')),
 'chunk_count', (SELECT count(*) FROM public.knowledge_chunks WHERE source_id IN ('d8d4135c-ebb0-a85a-e945-57fecad637fb', 'c9342f90-4955-0f31-d4e8-7e6e9c19d03e', '54dcb2e9-4d49-cef1-60b6-cbb53a8e3fea', 'a0179c21-e82d-f250-698b-df393135b4e8', '7129b5e0-7066-50fa-1b60-10d84ac0cfc1', 'd52fbd0f-5332-bd27-d80f-273617ef1ff5', '4bc5728a-21ce-fad4-c0d2-615a9c00c43b', 'f4c72547-0ece-83da-63b3-828558cfe068', '4b3a8e18-9f2f-cd7e-bce1-309338405146')),
 ...
 'legacy_sources', (SELECT json_agg(json_build_object('id',id,'status',status)) FROM public.knowledge_sources WHERE id IN ('6ebe6a6a-393a-4313-90c6-9ef0b922f9e5', '2676cf5e-216f-4642-a584-e0fac610b4a6')),
 'legacy_labels', (SELECT json_agg(json_build_object('id',id,'authority_level',authority_level)) FROM public.knowledge_chunks WHERE id IN ('58399be5-629d-4fb3-bc76-d70bd347e357', '8f4ec5eb-8aaf-431b-ba30-213229d11764', '184bc948-46f7-4c35-ab05-0901b30f2b37', '68a33188-648b-41e9-9d58-3ad6b154c051', 'b576c04e-4a81-4a72-89ea-72f364c01c1d', 'd6e61b42-b75f-4f61-9790-b7c1d7ced295', '1a9b3bf8-65b5-44da-abdb-6a5c73e5d7a8')),
 'section_counts', (SELECT json_agg(r) FROM (SELECT section,count(*) AS chunks FROM public.knowledge_chunks WHERE source_id IN ('d8d4135c-ebb0-a85a-e945-57fecad637fb', 'c9342f90-4955-0f31-d4e8-7e6e9c19d03e', '54dcb2e9-4d49-cef1-60b6-cbb53a8e3fea', 'a0179c21-e82d-f250-698b-df393135b4e8', '7129b5e0-7066-50fa-1b60-10d84ac0cfc1', 'd52fbd0f-5332-bd27-d80f-273617ef1ff5', '4bc5728a-21ce-fad4-c0d2-615a9c00c43b', 'f4c72547-0ece-83da-63b3-828558cfe068', '4b3a8e18-9f2f-cd7e-bce1-309338405146') GROUP BY section ORDER BY section) r)
) AS verification;
