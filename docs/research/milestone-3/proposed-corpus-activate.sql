...
-- Phase 2: ONLY after exact staged corpus passes the review's activation gates.
BEGIN;
...
IF (SELECT count(*) FROM public.knowledge_sources WHERE id IN ('d8d4135c-ebb0-a85a-e945-57fecad637fb', 'c9342f90-4955-0f31-d4e8-7e6e9c19d03e', '54dcb2e9-4d49-cef1-60b6-cbb53a8e3fea', 'a0179c21-e82d-f250-698b-df393135b4e8', '7129b5e0-7066-50fa-1b60-10d84ac0cfc1', 'd52fbd0f-5332-bd27-d80f-273617ef1ff5', '4bc5728a-21ce-fad4-c0d2-615a9c00c43b', 'f4c72547-0ece-83da-63b3-828558cfe068', '4b3a8e18-9f2f-cd7e-bce1-309338405146') AND status = 'staged_provenance_review') <> 9 THEN RAISE EXCEPTION 'Staged source state changed'; END IF;
...
END; $guard$;
UPDATE public.knowledge_chunks SET authority_level = 'derived' WHERE id IN ('58399be5-629d-4fb3-bc76-d70bd347e357', '8f4ec5eb-8aaf-431b-ba30-213229d11764', '184bc948-46f7-4c35-ab05-0901b30f2b37', 'b576c04e-4a81-4a72-89ea-72f364c01c1d', 'd6e61b42-b75f-4f61-9790-b7c1d7ced295', '1a9b3bf8-65b5-44da-abdb-6a5c73e5d7a8');
UPDATE public.knowledge_sources SET status = 'superseded' WHERE id IN ('6ebe6a6a-393a-4313-90c6-9ef0b922f9e5', '2676cf5e-216f-4642-a584-e0fac610b4a6');
UPDATE public.knowledge_sources SET status = 'current' WHERE id IN ('d8d4135c-ebb0-a85a-e945-57fecad637fb', 'c9342f90-4955-0f31-d4e8-7e6e9c19d03e', '54dcb2e9-4d49-cef1-60b6-cbb53a8e3fea', 'a0179c21-e82d-f250-698b-df393135b4e8', '7129b5e0-7066-50fa-1b60-10d84ac0cfc1', 'd52fbd0f-5332-bd27-d80f-273617ef1ff5', '4bc5728a-21ce-fad4-c0d2-615a9c00c43b', 'f4c72547-0ece-83da-63b3-828558cfe068', '4b3a8e18-9f2f-cd7e-bce1-309338405146');
COMMIT;
